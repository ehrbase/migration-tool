...
public class SessionLog extends TableImpl<SessionLogRecord> {
     ...
     */
    public final TableField<SessionLogRecord, Short> SYS_TENANT = createField(
            DSL.name("sys_tenant"),
    ...
    public Tenant tenant() {
        if (_tenant == null) _tenant = new Tenant(this, Keys.SESSION_LOG__SESSION_LOG_SYS_TENANT_FKEY);
