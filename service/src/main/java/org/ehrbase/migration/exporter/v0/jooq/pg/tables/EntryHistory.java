...
public class EntryHistory extends TableImpl<EntryHistoryRecord> {
     ...
     */
    public final TableField<EntryHistoryRecord, DvCodedTextRecord> NAME = createField(
            DSL.name("name"),
            org.ehrbase.migration.exporter.v0.jooq.pg.udt.DvCodedText.DV_CODED_TEXT.getDataType(),
            this,
            "");
     ...
     */
    public final TableField<EntryHistoryRecord, Short> SYS_TENANT = createField(
            DSL.name("sys_tenant"),
    ...
    public Tenant tenant() {
        if (_tenant == null) _tenant = new Tenant(this, Keys.ENTRY_HISTORY__ENTRY_HISTORY_SYS_TENANT_FKEY);
