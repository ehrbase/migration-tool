...
public class Composition extends TableImpl<CompositionRecord> {
     ...
     */
    public final TableField<CompositionRecord, Short> SYS_TENANT = createField(
            DSL.name("sys_tenant"),
    ...
    public org.ehrbase.migration.exporter.v0.jooq.pg.tables.Ehr ehr() {
        if (_ehr == null)
            _ehr = new org.ehrbase.migration.exporter.v0.jooq.pg.tables.Ehr(
                    this, Keys.COMPOSITION__COMPOSITION_EHR_ID_FKEY);
    ...
    public Tenant tenant() {
        if (_tenant == null) _tenant = new Tenant(this, Keys.COMPOSITION__COMPOSITION_SYS_TENANT_FKEY);
