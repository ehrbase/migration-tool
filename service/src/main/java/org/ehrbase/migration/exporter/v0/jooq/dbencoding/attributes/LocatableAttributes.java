...
import org.ehrbase.migration.exporter.v0.jooq.dbencoding.NameInMap;
...
public abstract class LocatableAttributes extends RMAttributes {
    ...
    protected Map<String, Object> toMap(Locatable locatable) {
        ...
        // since name maybe resolved from the archetype node id
        if (!map.containsKey(TAG_NAME) && locatable.getName() != null) {
