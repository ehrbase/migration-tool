...
public class CompoXref extends TableImpl<CompoXrefRecord> {
     ...
     */
    public final TableField<CompoXrefRecord, Short> SYS_TENANT = createField(
            DSL.name("sys_tenant"),
    ...
    public List<ForeignKey<CompoXrefRecord, ?>> getReferences() {
        return Arrays.asList(
                Keys.COMPO_XREF__COMPO_XREF_MASTER_UUID_FKEY,
                Keys.COMPO_XREF__COMPO_XREF_CHILD_UUID_FKEY,
                Keys.COMPO_XREF__COMPO_XREF_SYS_TENANT_FKEY);
    }
    ...
    public Tenant tenant() {
        if (_tenant == null) _tenant = new Tenant(this, Keys.COMPO_XREF__COMPO_XREF_SYS_TENANT_FKEY);
    ...
    public <U> SelectField<U> mapping(
            Function4<? super UUID, ? super UUID, ? super Timestamp, ? super Short, ? extends U> from) {
