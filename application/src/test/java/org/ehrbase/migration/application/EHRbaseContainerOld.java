...
public class EHRbaseContainerOld extends GenericContainer {
    ...
    public EHRbaseContainerOld(Network network, List<Startable> startables) {
        super(IMAGE);
        withNetwork(network);
    ...
    protected void configure() {
        addEnv(
                ...
                "jdbc:postgresql://%s:%s/ehrbase"
                        .formatted(EHRbasePostgresOldContainer.CONTAINER_NAME, EHRbasePostgresOldContainer.PORT));
