...
public class EHRbasePostgresOldContainer extends GenericContainer {

    public static final Integer PORT = 5432;
    public static final String CONTAINER_NAME = "old_postgres";
    ...
    public EHRbasePostgresOldContainer(Network network) {
        super(IMAGE);
